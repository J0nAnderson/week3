 ...
 * Step 1: Convert the alphabetString to an array and print it to the console (See documentation:
...
/*
 * Using the provided code above:
 * Step 1: Reorganize the alphabet array from z to a (See documentation:
 * https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reverse)
 * Step 2: Convert the elements of the array into a string (with no spaces between the letters) and print it to the console (See documentation:
 ...
 * Step 4: Add 16 and 3 to array1 and Print the updated array.(See documentation:
...
console.log("Numeric order: ", array1)

console.log("Alternate Step 5: ", array1[2]);

console.log("Alternate Step 6: ", array1[array1.length -1])
 ...
 * Step 2: Add three todo items (elements) to the array using a built-in array method, then print myTodoList to the console (See documentation:
 * https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/push)
 ...
 * Step 5: Create another array called ourTodoList, then concatenate (combine) myTodoList and yourTodoList into the array ourTodoList, there's more than one way to do this.(See documentation:
 * https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/concat  OR  https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax)
 * 
 * 
 * ↓ YOUR CODE HERE ↓ */

let myToDoList = [];
console.log ("Step 1: Empty list");

myToDoList.push("Free-dive Deans Blue Hole", "Free-solo El Capitan", "Freerun in France");
console.log("Step 2:", myToDoList);

noSolo = myToDoList.splice(1, 1);
console.log("Step 3: ", myToDoList);

let yourToDoList = ["Freestyle Snowboard Wolf Creek", "Freefly in Dubai"]
